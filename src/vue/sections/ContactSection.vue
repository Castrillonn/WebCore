            ...
            <div class="row contact-form-row align-items-stretch">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group input-group">
                        ...
                        <input class="form-control" id="form-name" type="text" placeholder="Nombre *" required/>
                    </div>

                    <!-- E-mail Address Input -->
                    <div class="form-group input-group">
                        <span class="input-group-text input-group-attach"><i class="fa fa-envelope"/></span>
                        <input class="form-control" id="form-email" type="email" placeholder="Correo *" required/>
                    </div>

                    <!-- Subject Input -->
                    <div class="form-group input-group">
                        <span class="input-group-text input-group-attach"><i class="fa fa-pen-to-square"/></span>
                        <input class="form-control" id="form-subject" type="text" placeholder="Asunto *" required/>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group form-group-textarea mb-md-0">
                        <textarea class="form-control" id="form-message" placeholder="Mensaje *" required/>
                    </div>
                </div>

                <!-- Bottom Column -->
                <div class="col-12 text-center mt-2 mt-lg-4">
                    <XLButton :label="'Enviar'"
                            :type="'submit'"
